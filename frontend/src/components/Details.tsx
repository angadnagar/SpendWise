export const Details=()=>{
    return(
        ...
        <div className="flex flex-row justify-center items-center p-4">
            ...
            <div className=" w-5/12 p-8">
                <img className=" h-auto" src="/about-2.jpg" alt="expenser" data-aos="fade-up" data-aos-delay="400" />
            </div>
        ...
        <div className="flex flex-row justify-center items-center p-4">
            ...
            <div className=" w-5/12 p-8 ">
                <img className=" h-auto" src="/about-3.jpg" alt="expenser" data-aos="fade-up" data-aos-delay="800" />
            </div>
            <div className="w-1/2 p-8 " data-aos="fade-down" data-aos-delay="800">
        ...
        <div className="flex flex-row justify-center items-center p-4">
            ...
            <div className="w-5/12 p-8 " data-aos="fade-down" data-aos-delay="1100">
            ...
            <div className=" w-5/12 p-8">
                <img className=" h-auto" src="/about-4.jpg" alt="expenser" data-aos="fade-up" data-aos-delay="1100" />
            </div>
